<template>
  <div v-editable="blok" class="min-h-[500px] relative flex items-end justify-center my-6 rounded-[5px] overflow-hidden"
    :class="heroClasses">
...
const heroClasses = computed(() => {
  return props.blok.layout === 'container' ? 'container mx-auto' : ''
})
</script>